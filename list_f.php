...
$jof = 1;
$meta = new Metas(1);
$metadata = $meta->getMeta($query,$type,1);
?>
<!DOCTYPE html>
<html lang="zh-Hans">
<!--<html lang="zh-Hant">-->
...
<!--                  首页-->
              ...
              <li>
                <a onclick="tolist('category',encodeURI('武俠'),1,'all')" href="javascript:void(0)">
...
<!--                  武侠-->
              ...
              <li>
                <a onclick="tolist('category',encodeURI('校園'),1,'all')" href="javascript:void(0)">
...
<!--                  校园-->
              ...
              <li class="dropdown visible-desktop">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a onclick="tolist('category',encodeURI('仙俠'),1,'all')" href="javascript:void(0)">
...
<!--                      仙侠-->
                  ...
                  <li>
                    <a onclick="tolist('category',encodeURI('歷史'),1,'all')" href="javascript:void(0)">
...
<!--                      历史-->
                  ...
                  <li>
                    <a onclick="tolist('category',encodeURI('總裁'),1,'all')" href="javascript:void(0)">
...
<!--                      总裁-->
                  ...
                  <li>
                    <a onclick="tolist('category',encodeURI('遊戲'),1,'all')" href="javascript:void(0)">
...
<!--                      游戏-->
                  ...
                  <li>
                    <a onclick="tolist('category',encodeURI('異能'),1,'all')" href="javascript:void(0)">
...
<!--                      异能-->
                  ...
                  <li>
                    <a onclick="tolist('category',encodeURI('經典'),1,'all')" href="javascript:void(0)">
...
<!--                  <input class="span2 input-medium search-query" id="query" type="search" placeholder="请用简体搜索">-->
					<input class="span2 input-medium search-query" id="query" type="search" placeholder="请用繁體搜索">
            ...
            <button class="pull-right btn btn-inverse" onclick="tojianti()" id="jf">
        ...
        <!--面包屑导航提示层 在list层中固定展示，根据不同的业务显示不一样的id-->
          <div id="list" style="display: block">
            ...
            <div class="alert" id="noresult" style="display:none;">
                ...
                <a class="btn btn-info" href="list_f.php?type=all&query=all&sex=all#1">全部书籍</a>
            </div>
            ...
            <div id="info" style="display: none">
              ...
              <div class="widget" id="info-bookmark" style="display:none;">
                <div class="sidecontent">
                  ...
                  <button class="btn pull-right">繼續閱讀</button>
...
<!--                    下载地址-->
                  ...
                  <div>
                    ...
                    <div class="span4 visible-desktop" id="downloadqr">
                      <img id="downloadimg" src="#" alt="下载地址">
<!--                      <h5>扫码下载全文</h5>-->
                      <h5>掃碼下載全文</h5>
                    </div>
                    <ul  class="span8">
...
<!--					<a onclick="tolist('category',encodeURI('经典'),1,0)" href="javascript:void(0)">经典</a>-->
					<a onclick="tolist('category',encodeURI('都市'),1,0)" href="javascript:void(0)">都市</a>
					<a onclick="tolist('category',encodeURI('武俠'),1,0)" href="javascript:void(0)">武俠</a>
					<a onclick="tolist('category',encodeURI('奇幻'),1,0)" href="javascript:void(0)">奇幻</a>
					<a onclick="tolist('category',encodeURI('仙俠'),1,0)" href="javascript:void(0)">仙侠</a>
					<a onclick="tolist('category',encodeURI('修真'),1,0)" href="javascript:void(0)">修真</a>
					<a onclick="tolist('category',encodeURI('異能'),1,0)" href="javascript:void(0)">異能</a>
					<a onclick="tolist('category',encodeURI('科幻'),1,0)" href="javascript:void(0)">科幻</a>
					<a onclick="tolist('category',encodeURI('歷史'),1,0)" href="javascript:void(0)">歷史</a>
					<a onclick="tolist('category',encodeURI('穿越'),1,0)" href="javascript:void(0)">穿越</a>
					<a onclick="tolist('category',encodeURI('同人'),1,0)" href="javascript:void(0)">同人</a>
					<a onclick="tolist('category',encodeURI('遊戲'),1,0)" href="javascript:void(0)">遊戲</a>
					<a onclick="tolist('category',encodeURI('校園'),1,0)" href="javascript:void(0)">校園</a>
					<a onclick="tolist('category',encodeURI('經典'),1,0)" href="javascript:void(0)">經典</a>
...
<!--					<a onclick="tolist('category',encodeURI('古代言情'),1,1)" href="javascript:void(0)">古代言情</a>-->
					<a onclick="tolist('category',encodeURI('都市'),1,1)" href="javascript:void(0)">都市</a>
					<a onclick="tolist('category',encodeURI('武俠'),1,1)" href="javascript:void(0)">武俠</a>
					<a onclick="tolist('category',encodeURI('奇幻'),1,1)" href="javascript:void(0)">奇幻</a>
					<a onclick="tolist('category',encodeURI('仙俠'),1,1)" href="javascript:void(0)">仙俠</a>
					<a onclick="tolist('category',encodeURI('耽美'),1,1)" href="javascript:void(0)">耽美</a>
					<a onclick="tolist('category',encodeURI('異能'),1,1)" href="javascript:void(0)">異能</a>
					<a onclick="tolist('category',encodeURI('科幻'),1,1)" href="javascript:void(0)">科幻</a>
					<a onclick="tolist('category',encodeURI('總裁'),1,1)" href="javascript:void(0)">總裁</a>
					<a onclick="tolist('category',encodeURI('穿越'),1,1)" href="javascript:void(0)">穿越</a>
					<a onclick="tolist('category',encodeURI('同人'),1,1)" href="javascript:void(0)">同人</a>
					<a onclick="tolist('category',encodeURI('遊戲'),1,1)" href="javascript:void(0)">遊戲</a>
					<a onclick="tolist('category',encodeURI('校園'),1,1)" href="javascript:void(0)">校園</a>
					<a onclick="tolist('category',encodeURI('古代言情'),1,1)" href="javascript:void(0)">古代言情</a>
                	<!--<a href="list.php?cid=01&sex=boy#cate">都市</a>
                  <a href="list.php?cid=02&sex=boy#cate">武俠</a>
                  <a href="list.php?cid=03&sex=boy#cate">奇幻</a>
	...
	<script type="text/javascript">
		...
		function tojianti(){
			...
			location.href = 'list.php?type='+type+'&query='+query+'&sex='+sex+'#'+page;
		}
	</script>
	...
	<script type="text/javascript">
		...
		function tolist(types,querys,pages,sexs){
			location.href = 'list_f.php?type='+types+'&query='+querys+'&sex='+sexs+'#'+pages;
		}
		listshow(type);
	</script>
	<script type="text/javascript" src="js/Tatf.js"></script>
	<script>
		...
		function searchs(){
			...
			if (query.length == 0) {
				...
				location.href = 'list_f.php?type=query&query=' + query + '&sex=0#1';
			}
		}
	</script>
</body></html>